...
exports.refund = exports.dispute = exports.release = exports.getAll = void 0;
const escrowService = __importStar(require("../services/escrow.service"));
const adminAuditService = __importStar(require("../services/adminAudit.service"));
...
exports.release = (0, catchAsync_1.default)(async (req, res) => {
...
exports.dispute = (0, catchAsync_1.default)(async (req, res) => {
...
exports.refund = (0, catchAsync_1.default)(async (req, res) => {
