...
export declare const deleteOne: (req: Request, res: Response, next: import("express").NextFunction) => void;
export declare const updateRole: (req: Request, res: Response, next: import("express").NextFunction) => void;
