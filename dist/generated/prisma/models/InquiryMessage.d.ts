...
export type GetInquiryMessageAggregateType<T extends InquiryMessageAggregateArgs> = {
    [P in keyof T & keyof AggregateInquiryMessage]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateInquiryMessage[P]> : Prisma.GetScalarType<T[P], AggregateInquiryMessage[P]>;
};
...
export type GetInquiryMessageGroupByPayload<T extends InquiryMessageGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<InquiryMessageGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof InquiryMessageGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], InquiryMessageGroupByOutputType[P]> : Prisma.GetScalarType<T[P], InquiryMessageGroupByOutputType[P]>;
}>>;
export type InquiryMessageWhereInput = {
    ...
    id?: Prisma.IntFilter<"InquiryMessage"> | number;
    inquiryId?: Prisma.IntFilter<"InquiryMessage"> | number;
    sender?: Prisma.StringFilter<"InquiryMessage"> | string;
    text?: Prisma.StringFilter<"InquiryMessage"> | string;
    timestamp?: Prisma.StringNullableFilter<"InquiryMessage"> | string | null;
...
export type InquiryMessageOrderByWithRelationInput = {
    ...
    _relevance?: Prisma.InquiryMessageOrderByRelevanceInput;
};
...
export type InquiryMessageScalarWhereWithAggregatesInput = {
    ...
    id?: Prisma.IntWithAggregatesFilter<"InquiryMessage"> | number;
    inquiryId?: Prisma.IntWithAggregatesFilter<"InquiryMessage"> | number;
    sender?: Prisma.StringWithAggregatesFilter<"InquiryMessage"> | string;
    text?: Prisma.StringWithAggregatesFilter<"InquiryMessage"> | string;
    timestamp?: Prisma.StringNullableWithAggregatesFilter<"InquiryMessage"> | string | null;
...
export type InquiryMessageOrderByRelevanceInput = {
    fields: Prisma.InquiryMessageOrderByRelevanceFieldEnum | Prisma.InquiryMessageOrderByRelevanceFieldEnum[];
...
export type InquiryMessageOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "inquiryId" | "sender" | "text" | "timestamp" | "createdAt", ExtArgs["result"]["inquiryMessage"]>;
...
export type InquiryMessageCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<InquiryMessageFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface InquiryMessageDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['InquiryMessage'];
        meta: {
            name: 'InquiryMessage';
        };
    };
     ...
     * })
    **/
    count<T extends InquiryMessageCountArgs>(args?: Prisma.Subset<T, InquiryMessageCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], InquiryMessageCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends InquiryMessageGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, InquiryMessageGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetInquiryMessageGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface InquiryMessageFieldRefs {
    readonly id: Prisma.FieldRef<"InquiryMessage", 'Int'>;
    readonly inquiryId: Prisma.FieldRef<"InquiryMessage", 'Int'>;
    readonly sender: Prisma.FieldRef<"InquiryMessage", 'String'>;
    readonly text: Prisma.FieldRef<"InquiryMessage", 'String'>;
    readonly timestamp: Prisma.FieldRef<"InquiryMessage", 'String'>;
...
//# sourceMappingURL=InquiryMessage.d.ts.map